Svelte 5 introduced some significant changes to Svelte’s API, including [runes](https://svelte.dev/docs/svelte/what-are-runes), [snippets](https://svelte.dev/docs/svelte/snippet) and event attributes. As a result, some Svelte 3/4 features are deprecated (though supported for now, unless otherwise specified) and will eventually be removed. We recommend that you incrementally [migrate your existing code](https://svelte.dev/docs/svelte/v5-migration-guide).
