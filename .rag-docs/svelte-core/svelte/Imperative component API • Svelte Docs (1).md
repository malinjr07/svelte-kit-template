...
## Creating a component[](https://svelte.dev/docs/svelte/legacy-component-api#Creating-a-component)
...
> In Svelte 5+, use [`mount`](https://svelte.dev/docs/svelte/svelte#mount) instead

## $set[](https://svelte.dev/docs/svelte/legacy-component-api#$set)
...
## $on[](https://svelte.dev/docs/svelte/legacy-component-api#$on)
...
## $destroy[](https://svelte.dev/docs/svelte/legacy-component-api#$destroy)

Removes a component from the DOM and triggers any `onDestroy` handlers.

> In Svelte 5+, use [`unmount`](https://svelte.dev/docs/svelte/svelte#unmount) instead

## Component props[](https://svelte.dev/docs/svelte/legacy-component-api#Component-props)
...
## Server-side component API[](https://svelte.dev/docs/svelte/legacy-component-api#Server-side-component-API)
...
> In Svelte 5+, use [`render`](https://svelte.dev/docs/svelte/svelte-server#render) instead