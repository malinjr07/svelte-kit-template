## I’m new to Svelte. Where should I start?[](https://svelte.dev/docs/svelte/faq#I'm-new-to-Svelte.-Where-should-I-start)
...
## Where can I get support?[](https://svelte.dev/docs/svelte/faq#Where-can-I-get-support)
...
## Are there any third-party resources?[](https://svelte.dev/docs/svelte/faq#Are-there-any-third-party-resources)
...
## How can I get VS Code to syntax-highlight my .svelte files?[](https://svelte.dev/docs/svelte/faq#How-can-I-get-VS-Code-to-syntax-highlight-my-.svelte-files)
...
## How do I document my components?[](https://svelte.dev/docs/svelte/faq#How-do-I-document-my-components)
...
## Does Svelte scale?[](https://svelte.dev/docs/svelte/faq#Does-Svelte-scale)
...
## Is there a UI component library?[](https://svelte.dev/docs/svelte/faq#Is-there-a-UI-component-library)

There are several [UI component libraries](https://svelte.dev/packages#component-libraries) as well as standalone components listed on [the packages page](https://svelte.dev/packages).

## How do I test Svelte apps?[](https://svelte.dev/docs/svelte/faq#How-do-I-test-Svelte-apps)
...
-   [Svelte docs on testing](https://svelte.dev/docs/svelte/testing)
...
## Is there a router?[](https://svelte.dev/docs/svelte/faq#Is-there-a-router)

The official routing library is [SvelteKit](https://svelte.dev/docs/kit). SvelteKit provides a filesystem router, server-side rendering (SSR), and hot module reloading (HMR) in one easy-to-use package. It shares similarities with Next.js for React and Nuxt.js for Vue.

However, you can use any router library. A sampling of available routers are highlighted [on the packages page](https://svelte.dev/packages#routing).

## How do I write a mobile app with Svelte?[](https://svelte.dev/docs/svelte/faq#How-do-I-write-a-mobile-app-with-Svelte)
...
## Can I tell Svelte not to remove my unused styles?[](https://svelte.dev/docs/svelte/faq#Can-I-tell-Svelte-not-to-remove-my-unused-styles)
...
## Is Svelte v2 still available?[](https://svelte.dev/docs/svelte/faq#Is-Svelte-v2-still-available)
...
## How do I do hot module reloading?[](https://svelte.dev/docs/svelte/faq#How-do-I-do-hot-module-reloading)
