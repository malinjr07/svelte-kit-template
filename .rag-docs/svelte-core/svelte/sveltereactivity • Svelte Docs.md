...
## SvelteDate[](https://svelte.dev/docs/svelte/svelte-reactivity#SvelteDate)
...
## SvelteMap[](https://svelte.dev/docs/svelte/svelte-reactivity#SvelteMap)
...
## SvelteSet[](https://svelte.dev/docs/svelte/svelte-reactivity#SvelteSet)
...
## SvelteURL[](https://svelte.dev/docs/svelte/svelte-reactivity#SvelteURL)
