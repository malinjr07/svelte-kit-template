...
## VERSION[](https://svelte.dev/docs/svelte/svelte-compiler#VERSION)

The current version, as set in package.json.

## compile[](https://svelte.dev/docs/svelte/svelte-compiler#compile)
...
## compileModule[](https://svelte.dev/docs/svelte/svelte-compiler#compileModule)
...
## migrate[](https://svelte.dev/docs/svelte/svelte-compiler#migrate)
...
## parse[](https://svelte.dev/docs/svelte/svelte-compiler#parse)
...
## preprocess[](https://svelte.dev/docs/svelte/svelte-compiler#preprocess)
...
## print[](https://svelte.dev/docs/svelte/svelte-compiler#print)
...
## walk[](https://svelte.dev/docs/svelte/svelte-compiler#walk)

> Replace this with `import { walk } from 'estree-walker'`

## AST[](https://svelte.dev/docs/svelte/svelte-compiler#AST)
...
## CompileError[](https://svelte.dev/docs/svelte/svelte-compiler#CompileError)

```java
interface CompileError extends ICompileDiagnostic {}
```

## CompileOptions[](https://svelte.dev/docs/svelte/svelte-compiler#CompileOptions)
...
## CompileResult[](https://svelte.dev/docs/svelte/svelte-compiler#CompileResult)
...
## MarkupPreprocessor[](https://svelte.dev/docs/svelte/svelte-compiler#MarkupPreprocessor)
...
## ModuleCompileOptions[](https://svelte.dev/docs/svelte/svelte-compiler#ModuleCompileOptions)
...
## Preprocessor[](https://svelte.dev/docs/svelte/svelte-compiler#Preprocessor)
...
## PreprocessorGroup[](https://svelte.dev/docs/svelte/svelte-compiler#PreprocessorGroup)
...
## Processed[](https://svelte.dev/docs/svelte/svelte-compiler#Processed)
...
## Warning[](https://svelte.dev/docs/svelte/svelte-compiler#Warning)
