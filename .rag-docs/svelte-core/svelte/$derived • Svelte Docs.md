...
## $derived.by[](https://svelte.dev/docs/svelte/$derived#$derived.by)
...
## Understanding dependencies[](https://svelte.dev/docs/svelte/$derived#Understanding-dependencies)
...
## Overriding derived values[](https://svelte.dev/docs/svelte/$derived#Overriding-derived-values)
...
## Destructuring[](https://svelte.dev/docs/svelte/$derived#Destructuring)
...
## Update propagation[](https://svelte.dev/docs/svelte/$derived#Update-propagation)
