...
## Function bindings[](https://svelte.dev/docs/svelte/bind#Function-bindings)
...
In the case of readonly bindings like [dimension bindings](https://svelte.dev/docs/svelte/bind#Dimensions), the `get` value should be `null`:
...
## <input bind:value>[](https://svelte.dev/docs/svelte/bind#input-bind:value)
...
## <input bind:checked>[](https://svelte.dev/docs/svelte/bind#input-bind:checked)
...
## <input bind:indeterminate>[](https://svelte.dev/docs/svelte/bind#input-bind:indeterminate)
...
## <input bind:group>[](https://svelte.dev/docs/svelte/bind#input-bind:group)
...
## <input bind:files>[](https://svelte.dev/docs/svelte/bind#input-bind:files)
...
## <select bind:value>[](https://svelte.dev/docs/svelte/bind#select-bind:value)
...
## <audio>[](https://svelte.dev/docs/svelte/bind#audio)
...
## <video>[](https://svelte.dev/docs/svelte/bind#video)

`<video>` elements have all the same bindings as [`<audio>`](https://svelte.dev/docs/svelte/bind#audio) elements, plus readonly [`videoWidth`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLVideoElement/videoWidth) and [`videoHeight`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLVideoElement/videoHeight) bindings.

## <img>[](https://svelte.dev/docs/svelte/bind#img)
...
## <details bind:open>[](https://svelte.dev/docs/svelte/bind#details-bind:open)
...
## window and document[](https://svelte.dev/docs/svelte/bind#window-and-document)

To bind to properties of `window` and `document`, see [`<svelte:window>`](https://svelte.dev/docs/svelte/svelte-window) and [`<svelte:document>`](https://svelte.dev/docs/svelte/svelte-document).

## Contenteditable bindings[](https://svelte.dev/docs/svelte/bind#Contenteditable-bindings)
...
## bind:this[](https://svelte.dev/docs/svelte/bind#bind:this)
...
> In case of using [the function bindings](https://svelte.dev/docs/svelte/bind#Function-bindings), the getter is required to ensure that the correct value is nullified on component or element destruction.

## bind:_property_ for components[](https://svelte.dev/docs/svelte/bind#bind:property-for-components)
