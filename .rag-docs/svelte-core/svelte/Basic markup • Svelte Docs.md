...
## Element attributes[](https://svelte.dev/docs/svelte/basic-markup#Element-attributes)
...
## Component props[](https://svelte.dev/docs/svelte/basic-markup#Component-props)
...
## Spread attributes[](https://svelte.dev/docs/svelte/basic-markup#Spread-attributes)
...
## Events[](https://svelte.dev/docs/svelte/basic-markup#Events)
...
### Event delegation[](https://svelte.dev/docs/svelte/basic-markup#Events-Event-delegation)
...
## Text expressions[](https://svelte.dev/docs/svelte/basic-markup#Text-expressions)
