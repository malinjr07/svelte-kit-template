...
## <script lang="ts">[](https://svelte.dev/docs/svelte/typescript#script-lang-ts)
...
## Preprocessor setup[](https://svelte.dev/docs/svelte/typescript#Preprocessor-setup)
...
### Using SvelteKit or Vite[](https://svelte.dev/docs/svelte/typescript#Preprocessor-setup-Using-SvelteKit-or-Vite)
...
### Other build tools[](https://svelte.dev/docs/svelte/typescript#Preprocessor-setup-Other-build-tools)
...
## tsconfig.json settings[](https://svelte.dev/docs/svelte/typescript#tsconfig.json-settings)
...
## Generic $props[](https://svelte.dev/docs/svelte/typescript#Generic-$props)
...
## Typing wrapper components[](https://svelte.dev/docs/svelte/typescript#Typing-wrapper-components)
...
## Typing $state[](https://svelte.dev/docs/svelte/typescript#Typing-$state)
...
## The Component type[](https://svelte.dev/docs/svelte/typescript#The-Component-type)
...
## Enhancing built-in DOM types[](https://svelte.dev/docs/svelte/typescript#Enhancing-built-in-DOM-types)
