This module provides types for [actions](https://svelte.dev/docs/svelte/use), which have been superseded by [attachments](https://svelte.dev/docs/svelte/@attach).

## Action[](https://svelte.dev/docs/svelte/svelte-action#Action)
...
## ActionReturn[](https://svelte.dev/docs/svelte/svelte-action#ActionReturn)
