...
> This behaviour will only work when the function passed to `onMount` is _synchronous_. `async` functions always return a `Promise`.
...
## Deprecated: beforeUpdate / afterUpdate[](https://svelte.dev/docs/svelte/lifecycle-hooks#Deprecated:-beforeUpdate-afterUpdate)
...
### Chat window example[](https://svelte.dev/docs/svelte/lifecycle-hooks#Deprecated:-beforeUpdate-afterUpdate-Chat-window-example)
