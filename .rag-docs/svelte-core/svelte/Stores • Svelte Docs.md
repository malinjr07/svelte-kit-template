...
## When to use stores[](https://svelte.dev/docs/svelte/stores#When-to-use-stores)
...
## svelte/store[](https://svelte.dev/docs/svelte/stores#svelte-store)
...
### writable[](https://svelte.dev/docs/svelte/stores#svelte-store-writable)
...
### readable[](https://svelte.dev/docs/svelte/stores#svelte-store-readable)
...
### derived[](https://svelte.dev/docs/svelte/stores#svelte-store-derived)
...
### readonly[](https://svelte.dev/docs/svelte/stores#svelte-store-readonly)
...
### get[](https://svelte.dev/docs/svelte/stores#svelte-store-get)
...
## Store contract[](https://svelte.dev/docs/svelte/stores#Store-contract)
