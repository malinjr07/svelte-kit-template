Svelte components can also be compiled to custom elements (aka web components) using the `customElement: true` compiler option. You should specify a tag name for the component using the `<svelte:options>` [element](https://svelte.dev/docs/svelte/svelte-options). Within the custom element you can access the host element via the [`$host`](https://svelte.dev/docs/svelte/$host) rune.
...
Note that you need to list out all properties explicitly, i.e. doing `let props = $props()` without declaring `props` in the [component options](https://svelte.dev/docs/svelte/custom-elements#Component-options) means that Svelte can’t know which props to expose as properties on the DOM element.

## Component lifecycle[](https://svelte.dev/docs/svelte/custom-elements#Component-lifecycle)
...
## Component options[](https://svelte.dev/docs/svelte/custom-elements#Component-options)
...
## Caveats and limitations[](https://svelte.dev/docs/svelte/custom-elements#Caveats-and-limitations)
