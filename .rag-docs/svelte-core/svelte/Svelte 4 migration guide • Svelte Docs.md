...
## Minimum version requirements[](https://svelte.dev/docs/svelte/v4-migration-guide#Minimum-version-requirements)
...
## Browser conditions for bundlers[](https://svelte.dev/docs/svelte/v4-migration-guide#Browser-conditions-for-bundlers)
...
## Stricter types for Svelte functions[](https://svelte.dev/docs/svelte/v4-migration-guide#Stricter-types-for-Svelte-functions)
...
## Custom Elements with Svelte[](https://svelte.dev/docs/svelte/v4-migration-guide#Custom-Elements-with-Svelte)
...
This change was made to allow [more configurability](https://svelte.dev/docs/svelte/custom-elements#Component-options) for advanced use cases. The migration script will adjust your code automatically. The update timing of properties has changed slightly as well. ([#8457](https://github.com/sveltejs/svelte/issues/8457))

## SvelteComponentTyped is deprecated[](https://svelte.dev/docs/svelte/v4-migration-guide#SvelteComponentTyped-is-deprecated)
...
## Transitions are local by default[](https://svelte.dev/docs/svelte/v4-migration-guide#Transitions-are-local-by-default)
...
## Default slot bindings[](https://svelte.dev/docs/svelte/v4-migration-guide#Default-slot-bindings)
...
## Preprocessors[](https://svelte.dev/docs/svelte/v4-migration-guide#Preprocessors)
...
## New eslint package[](https://svelte.dev/docs/svelte/v4-migration-guide#New-eslint-package)
...
## Other breaking changes[](https://svelte.dev/docs/svelte/v4-migration-guide#Other-breaking-changes)
