...
## Claude Code[](https://svelte.dev/docs/mcp/local-setup#Claude-Code)
...
## Claude Desktop[](https://svelte.dev/docs/mcp/local-setup#Claude-Desktop)
...
## Codex CLI[](https://svelte.dev/docs/mcp/local-setup#Codex-CLI)
...
## Gemini CLI[](https://svelte.dev/docs/mcp/local-setup#Gemini-CLI)
...
## OpenCode[](https://svelte.dev/docs/mcp/local-setup#OpenCode)
...
## VS Code[](https://svelte.dev/docs/mcp/local-setup#VS-Code)
...
## Cursor[](https://svelte.dev/docs/mcp/local-setup#Cursor)
...
## Zed[](https://svelte.dev/docs/mcp/local-setup#Zed)
...
## Other clients[](https://svelte.dev/docs/mcp/local-setup#Other-clients)
