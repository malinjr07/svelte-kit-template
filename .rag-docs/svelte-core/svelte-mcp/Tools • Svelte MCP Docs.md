...
## list-sections[](https://svelte.dev/docs/mcp/tools#list-sections)

Provides a list of all the available documentation sections.

## get-documentation[](https://svelte.dev/docs/mcp/tools#get-documentation)

Allows the model to get the full (and up-to-date) documentation for the requested sections directly from [svelte.dev/docs](https://svelte.dev/docs).

## svelte-autofixer[](https://svelte.dev/docs/mcp/tools#svelte-autofixer)
...
## playground-link[](https://svelte.dev/docs/mcp/tools#playground-link)
