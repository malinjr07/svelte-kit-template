...
## Setup[](https://svelte.dev/docs/mcp/overview#Setup)
...
-   [local setup](https://svelte.dev/docs/mcp/local-setup) using `@sveltejs/mcp`
-   [remote setup](https://svelte.dev/docs/mcp/remote-setup) using `https://mcp.svelte.dev/mcp`

## Usage[](https://svelte.dev/docs/mcp/overview#Usage)
...
If your MCP client supports it, we also recommend using the [svelte-task](https://svelte.dev/docs/mcp/prompts#svelte-task) prompt to instruct the LLM on the best way to use the MCP server.