...
This adapter will be installed by default when you use [`adapter-auto`](https://svelte.dev/docs/kit/adapter-auto). If you plan on staying with Cloudflare, you can switch from [`adapter-auto`](https://svelte.dev/docs/kit/adapter-auto) to using this adapter directly so that `event.platform` is emulated during local development, type declarations are automatically applied, and the ability to set Cloudflare-specific options is provided.

## Comparisons[](https://svelte.dev/docs/kit/adapter-cloudflare#Comparisons)
...
## Usage[](https://svelte.dev/docs/kit/adapter-cloudflare#Usage)
...
## Options[](https://svelte.dev/docs/kit/adapter-cloudflare#Options)

### config[](https://svelte.dev/docs/kit/adapter-cloudflare#Options-config)
...
### platformProxy[](https://svelte.dev/docs/kit/adapter-cloudflare#Options-platformProxy)
...
### fallback[](https://svelte.dev/docs/kit/adapter-cloudflare#Options-fallback)
...
### routes[](https://svelte.dev/docs/kit/adapter-cloudflare#Options-routes)
...
## Cloudflare Workers[](https://svelte.dev/docs/kit/adapter-cloudflare#Cloudflare-Workers)

### Basic configuration[](https://svelte.dev/docs/kit/adapter-cloudflare#Cloudflare-Workers-Basic-configuration)
...
### Deployment[](https://svelte.dev/docs/kit/adapter-cloudflare#Cloudflare-Workers-Deployment)
...
## Cloudflare Pages[](https://svelte.dev/docs/kit/adapter-cloudflare#Cloudflare-Pages)

### Deployment[](https://svelte.dev/docs/kit/adapter-cloudflare#Cloudflare-Pages-Deployment)
...
### Further reading[](https://svelte.dev/docs/kit/adapter-cloudflare#Cloudflare-Pages-Further-reading)
...
### Notes[](https://svelte.dev/docs/kit/adapter-cloudflare#Cloudflare-Pages-Notes)

Functions contained in the [`/functions` directory](https://developers.cloudflare.com/pages/functions/routing/) at the project’s root will _not_ be included in the deployment. Instead, functions should be implemented as [server endpoints](https://svelte.dev/docs/kit/routing#server) in your SvelteKit app, which is compiled to a [single `_worker.js` file](https://developers.cloudflare.com/pages/functions/advanced-mode/).

## Runtime APIs[](https://svelte.dev/docs/kit/adapter-cloudflare#Runtime-APIs)
...
## Headers and redirects[](https://svelte.dev/docs/kit/adapter-cloudflare#Headers-and-redirects)
...
However, they will have no effect on responses dynamically rendered by SvelteKit, which should return custom headers or redirect responses from [server endpoints](https://svelte.dev/docs/kit/routing#server) or with the [`handle`](https://svelte.dev/docs/kit/hooks#Server-hooks-handle) hook.

## Troubleshooting[](https://svelte.dev/docs/kit/adapter-cloudflare#Troubleshooting)

### Node.js compatibility[](https://svelte.dev/docs/kit/adapter-cloudflare#Troubleshooting-Node.js-compatibility)
...
### Worker size limits[](https://svelte.dev/docs/kit/adapter-cloudflare#Troubleshooting-Worker-size-limits)
...
### Accessing the file system[](https://svelte.dev/docs/kit/adapter-cloudflare#Troubleshooting-Accessing-the-file-system)

You can’t use `fs` in Cloudflare Workers.

Instead, use the [`read`](https://svelte.dev/docs/kit/$app-server#read) function from `$app/server` to access your files. It works by fetching the file from the deployed public assets location.

Alternatively, you can [prerender](https://svelte.dev/docs/kit/page-options#prerender) the routes in question.

## Migrating from Workers Sites[](https://svelte.dev/docs/kit/adapter-cloudflare#Migrating-from-Workers-Sites)
...
### svelte.config.js[](https://svelte.dev/docs/kit/adapter-cloudflare#Migrating-from-Workers-Sites-svelte.config.js)
...
### wrangler.toml[](https://svelte.dev/docs/kit/adapter-cloudflare#Migrating-from-Workers-Sites-wrangler.toml)
...
### wrangler.jsonc[](https://svelte.dev/docs/kit/adapter-cloudflare#Migrating-from-Workers-Sites-wrangler.jsonc)
