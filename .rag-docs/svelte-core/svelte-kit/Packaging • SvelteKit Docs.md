...
When you’re creating an app, the contents of `src/routes` is the public-facing stuff; [`src/lib`](https://svelte.dev/docs/kit/$lib) contains your app’s internal library.
...
Running the `svelte-package` command from `@sveltejs/package` will take the contents of `src/lib` and generate a `dist` directory (which can be [configured](https://svelte.dev/docs/kit/packaging#Options)) containing the following:

-   All the files in `src/lib`. Svelte components will be preprocessed, TypeScript files will be transpiled to JavaScript.
-   Type definitions (`d.ts` files) which are generated for Svelte, JavaScript and TypeScript files. You need to install `typescript >= 4.0.0` for this. Type definitions are placed next to their implementation, hand-written `d.ts` files are copied over as is. You can [disable generation](https://svelte.dev/docs/kit/packaging#Options), but we strongly recommend against it — people using your library might use TypeScript, for which they require these type definition files.
...
## Anatomy of a package.json[](https://svelte.dev/docs/kit/packaging#Anatomy-of-a-package.json)
...
### name[](https://svelte.dev/docs/kit/packaging#Anatomy-of-a-package.json-name)
...
### license[](https://svelte.dev/docs/kit/packaging#Anatomy-of-a-package.json-license)
...
### files[](https://svelte.dev/docs/kit/packaging#Anatomy-of-a-package.json-files)
...
### exports[](https://svelte.dev/docs/kit/packaging#Anatomy-of-a-package.json-exports)
...
> Beware that doing this will need additional care if you provide type definitions. Read more about the caveat [here](https://svelte.dev/docs/kit/packaging#TypeScript)
...
### svelte[](https://svelte.dev/docs/kit/packaging#Anatomy-of-a-package.json-svelte)

This is a legacy field that enabled tooling to recognise Svelte component libraries. It’s no longer necessary when using the `svelte` [export condition](https://svelte.dev/docs/kit/packaging#Anatomy-of-a-package.json-exports), but for backwards compatibility with outdated tooling that doesn’t yet know about export conditions it’s good to keep it around. It should point towards your root entry point.
...
### sideEffects[](https://svelte.dev/docs/kit/packaging#Anatomy-of-a-package.json-sideEffects)
...
## Best practices[](https://svelte.dev/docs/kit/packaging#Best-practices)
...
Ensure that you add [aliases](https://svelte.dev/docs/kit/configuration#alias) via `svelte.config.js` (not `vite.config.js` or `tsconfig.json`), so that they are processed by `svelte-package`.
...
## Source maps[](https://svelte.dev/docs/kit/packaging#Source-maps)
...
## Options[](https://svelte.dev/docs/kit/packaging#Options)
...
## Publishing[](https://svelte.dev/docs/kit/packaging#Publishing)

To publish the generated package:

## Caveats[](https://svelte.dev/docs/kit/packaging#Caveats)
