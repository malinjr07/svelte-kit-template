## FAQs[](https://svelte.dev/docs/kit/additional-resources#FAQs)

Please see the [SvelteKit FAQ](https://svelte.dev/docs/kit/faq) for solutions to common issues and helpful tips and tricks.

The [Svelte FAQ](https://svelte.dev/docs/svelte/faq) and [`vite-plugin-svelte` FAQ](https://github.com/sveltejs/vite-plugin-svelte/blob/main/docs/faq.md) may also be helpful for questions deriving from those libraries.

## Examples[](https://svelte.dev/docs/kit/additional-resources#Examples)
...
## Support[](https://svelte.dev/docs/kit/additional-resources#Support)
