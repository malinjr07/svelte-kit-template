...
This adapter will be installed by default when you use [`adapter-auto`](https://svelte.dev/docs/kit/adapter-auto), but adding it to your project allows you to specify Netlify-specific options.

## Usage[](https://svelte.dev/docs/kit/adapter-netlify#Usage)
...
### Node version[](https://svelte.dev/docs/kit/adapter-netlify#Usage-Node-version)
...
## Netlify Edge Functions[](https://svelte.dev/docs/kit/adapter-netlify#Netlify-Edge-Functions)
...
## Netlify alternatives to SvelteKit functionality[](https://svelte.dev/docs/kit/adapter-netlify#Netlify-alternatives-to-SvelteKit-functionality)

You may build your app using functionality provided directly by SvelteKit without relying on any Netlify functionality. Using the SvelteKit versions of these features will allow them to be used in dev mode, tested with integration tests, and to work with other adapters should you ever decide to switch away from Netlify. However, in some scenarios you may find it beneficial to use the Netlify versions of these features. One example would be if you’re migrating an app that’s already hosted on Netlify to SvelteKit.

### \_headers and \_redirects[](https://svelte.dev/docs/kit/adapter-netlify#Netlify-alternatives-to-SvelteKit-functionality-_headers-and-_redirects)
...
### Redirect rules[](https://svelte.dev/docs/kit/adapter-netlify#Netlify-alternatives-to-SvelteKit-functionality-Redirect-rules)
...
### Netlify Forms[](https://svelte.dev/docs/kit/adapter-netlify#Netlify-alternatives-to-SvelteKit-functionality-Netlify-Forms)
...
2.  Netlify’s build bot parses your HTML files at deploy time, which means your form must be [prerendered](https://svelte.dev/docs/kit/page-options#prerender) as HTML. You can either add `export const prerender = true` to your `contact.svelte` to prerender just that page or set the `kit.prerender.force: true` option to prerender all pages.
...
### Netlify Functions[](https://svelte.dev/docs/kit/adapter-netlify#Netlify-alternatives-to-SvelteKit-functionality-Netlify-Functions)
...
## Troubleshooting[](https://svelte.dev/docs/kit/adapter-netlify#Troubleshooting)

### Accessing the file system[](https://svelte.dev/docs/kit/adapter-netlify#Troubleshooting-Accessing-the-file-system)

You can’t use `fs` in edge deployments.

You _can_ use it in serverless deployments, but it won’t work as expected, since files are not copied from your project into your deployment. Instead, use the [`read`](https://svelte.dev/docs/kit/$app-server#read) function from `$app/server` to access your files. It also works inside edge deployments by fetching the file from the deployed public assets location.
