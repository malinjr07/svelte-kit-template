...
## Sessions vs tokens[](https://svelte.dev/docs/kit/auth#Sessions-vs-tokens)
...
## Integration points[](https://svelte.dev/docs/kit/auth#Integration-points)

Auth [cookies](https://svelte.dev/docs/kit/@sveltejs-kit#Cookies) can be checked inside [server hooks](https://svelte.dev/docs/kit/hooks#Server-hooks). If a user is found matching the provided credentials, the user information can be stored in [`locals`](https://svelte.dev/docs/kit/hooks#Server-hooks-locals).

## Guides[](https://svelte.dev/docs/kit/auth#Guides)
