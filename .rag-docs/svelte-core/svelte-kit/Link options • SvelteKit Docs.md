...
## data-sveltekit-reload[](https://svelte.dev/docs/kit/link-options#data-sveltekit-reload)
...
## data-sveltekit-keepfocus[](https://svelte.dev/docs/kit/link-options#data-sveltekit-keepfocus)
