...
## Vite’s built-in handling[](https://svelte.dev/docs/kit/images#Vite's-built-in-handling)
...
### Basic usage[](https://svelte.dev/docs/kit/images#sveltejs-enhanced-img-Basic-usage)
...
### Dynamically choosing an image[](https://svelte.dev/docs/kit/images#sveltejs-enhanced-img-Dynamically-choosing-an-image)
...
### Intrinsic Dimensions[](https://svelte.dev/docs/kit/images#sveltejs-enhanced-img-Intrinsic-Dimensions)
...
### srcset and sizes[](https://svelte.dev/docs/kit/images#sveltejs-enhanced-img-srcset-and-sizes)
...
### Per-image transforms[](https://svelte.dev/docs/kit/images#sveltejs-enhanced-img-Per-image-transforms)
...
## Loading images dynamically from a CDN[](https://svelte.dev/docs/kit/images#Loading-images-dynamically-from-a-CDN)
...
## Best practices[](https://svelte.dev/docs/kit/images#Best-practices)
