In addition to the [`@debug`](https://svelte.dev/docs/svelte/@debug) tag, you can also debug Svelte and SvelteKit projects using breakpoints within various tools and development environments. This includes both frontend and backend code.

The following guides assume your JavaScript runtime environment is Node.js.

## Visual Studio Code[](https://svelte.dev/docs/kit/debugging#Visual-Studio-Code)
...
### Launch via debug pane[](https://svelte.dev/docs/kit/debugging#Visual-Studio-Code-Launch-via-debug-pane)
...
## Other Editors[](https://svelte.dev/docs/kit/debugging#Other-Editors)
...
## References[](https://svelte.dev/docs/kit/debugging#References)
