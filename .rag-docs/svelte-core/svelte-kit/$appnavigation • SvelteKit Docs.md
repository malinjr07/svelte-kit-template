...
## afterNavigate[](https://svelte.dev/docs/kit/$app-navigation#afterNavigate)
...
## beforeNavigate[](https://svelte.dev/docs/kit/$app-navigation#beforeNavigate)
...
## invalidate[](https://svelte.dev/docs/kit/$app-navigation#invalidate)
...
## invalidateAll[](https://svelte.dev/docs/kit/$app-navigation#invalidateAll)
...
## onNavigate[](https://svelte.dev/docs/kit/$app-navigation#onNavigate)
...
## preloadCode[](https://svelte.dev/docs/kit/$app-navigation#preloadCode)
...
## preloadData[](https://svelte.dev/docs/kit/$app-navigation#preloadData)
...
## pushState[](https://svelte.dev/docs/kit/$app-navigation#pushState)
...
## refreshAll[](https://svelte.dev/docs/kit/$app-navigation#refreshAll)

Causes all currently active remote functions to refresh, and all `load` functions belonging to the currently active page to re-run (unless disabled via the option argument). Returns a `Promise` that resolves when the page is subsequently updated.
...
## replaceState[](https://svelte.dev/docs/kit/$app-navigation#replaceState)
