...
-   The [`handle`](https://svelte.dev/docs/kit/hooks#Server-hooks-handle) hook and `handle` functions running in a [`sequence`](https://svelte.dev/docs/kit/@sveltejs-kit-hooks#sequence) (these will show up as children of each other and the root `handle` hook)
-   Server [`load`](https://svelte.dev/docs/kit/load) functions and universal `load` functions when they’re run on the server
...
## Augmenting the built-in tracing[](https://svelte.dev/docs/kit/observability#Augmenting-the-built-in-tracing)
...
## Development quickstart[](https://svelte.dev/docs/kit/observability#Development-quickstart)
...
## @opentelemetry/api[](https://svelte.dev/docs/kit/observability#opentelemetry-api)
