...
## Diagnosing issues[](https://svelte.dev/docs/kit/performance#Diagnosing-issues)
...
### Instrumenting[](https://svelte.dev/docs/kit/performance#Diagnosing-issues-Instrumenting)
...
## Optimizing assets[](https://svelte.dev/docs/kit/performance#Optimizing-assets)

### Images[](https://svelte.dev/docs/kit/performance#Optimizing-assets-Images)

Reducing the size of image files is often one of the most impactful changes you can make to a site’s performance. Svelte provides the `@sveltejs/enhanced-img` package, detailed on the [images](https://svelte.dev/docs/kit/images) page, for making this easier. Additionally, Lighthouse is useful for identifying the worst offenders.

### Videos[](https://svelte.dev/docs/kit/performance#Optimizing-assets-Videos)
...
## Reducing code size[](https://svelte.dev/docs/kit/performance#Reducing-code-size)

### Svelte version[](https://svelte.dev/docs/kit/performance#Reducing-code-size-Svelte-version)
...
### Packages[](https://svelte.dev/docs/kit/performance#Reducing-code-size-Packages)
...
### External scripts[](https://svelte.dev/docs/kit/performance#Reducing-code-size-External-scripts)
...
### Selective loading[](https://svelte.dev/docs/kit/performance#Reducing-code-size-Selective-loading)
...
## Navigation[](https://svelte.dev/docs/kit/performance#Navigation)

### Preloading[](https://svelte.dev/docs/kit/performance#Navigation-Preloading)
...
### Non-essential data[](https://svelte.dev/docs/kit/performance#Navigation-Non-essential-data)

For slow-loading data that isn’t needed immediately, the object returned from your `load` function can contain promises rather than the data itself. For server `load` functions, this will cause the data to [stream](https://svelte.dev/docs/kit/load#Streaming-with-promises) in after the navigation (or initial page load).

### Preventing waterfalls[](https://svelte.dev/docs/kit/performance#Navigation-Preventing-waterfalls)
...
## Further reading[](https://svelte.dev/docs/kit/performance#Further-reading)
