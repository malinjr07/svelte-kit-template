...
## Alternatives[](https://svelte.dev/docs/cli/devtools-json#Alternatives)
...
## Usage[](https://svelte.dev/docs/cli/devtools-json#Usage)

## What you get[](https://svelte.dev/docs/cli/devtools-json#What-you-get)
