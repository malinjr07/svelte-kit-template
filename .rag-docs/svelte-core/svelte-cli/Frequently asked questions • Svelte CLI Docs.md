## How do I run the sv CLI?[](https://svelte.dev/docs/cli/faq#How-do-I-run-the-sv-CLI)
...
## npx sv is not working[](https://svelte.dev/docs/cli/faq#npx-sv-is-not-working)
...
[Edit this page on GitHub](https://github.com/sveltejs/cli/edit/main/documentation/docs/10-introduction/20-faq.md) [llms.txt](https://svelte.dev/docs/cli/faq/llms.txt)