...
### Returns : self[](https://gsap.com/docs/v3/GSAP/Timeline/invalidate()/#returns--self "Direct link to Returns : self")

self (makes chaining easier)

### Details[](https://gsap.com/docs/v3/GSAP/Timeline/invalidate()/#details "Direct link to Details")
...
### Demo[](https://gsap.com/docs/v3/GSAP/Timeline/invalidate()/#demo "Direct link to Demo")
