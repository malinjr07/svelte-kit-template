...
```php
SplitText.create(".split", {  type: "lines, words",  mask: "lines",  autoSplit: true,  onSplit(self) {    return gsap.from(self.words, {      duration: 1,       y: 100,       autoAlpha: 0,       stagger: 0.05    });  }});
```
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/L1afzNAhI40?si=yt5g94qIK6vvEyH0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen=""></iframe>
...
## Splitting[](https://gsap.com/docs/v3/Plugins/SplitText/#splitting "Direct link to Splitting")

### Basic Usage[](https://gsap.com/docs/v3/Plugins/SplitText/#basic-usage "Direct link to Basic Usage")
...
### Configuration[](https://gsap.com/docs/v3/Plugins/SplitText/#configuration "Direct link to Configuration")
...
-   #### aria\*[](https://gsap.com/docs/v3/Plugins/SplitText/#aria*)
...
-   #### autoSplit\*[](https://gsap.com/docs/v3/Plugins/SplitText/#autoSplit*)
...
-   #### charsClass[](https://gsap.com/docs/v3/Plugins/SplitText/#charsClass)
...
-   #### deepSlice\*[](https://gsap.com/docs/v3/Plugins/SplitText/#deepSlice*)
...
-   #### ignore\*[](https://gsap.com/docs/v3/Plugins/SplitText/#ignore*)
...
-   #### linesClass[](https://gsap.com/docs/v3/Plugins/SplitText/#linesClass)
...
-   #### mask\*[](https://gsap.com/docs/v3/Plugins/SplitText/#mask*)
...
-   #### onRevert\*[](https://gsap.com/docs/v3/Plugins/SplitText/#onRevert*)
    
    Function - A function that gets called whenever the SplitText instance reverts
    
-   #### onSplit\*[](https://gsap.com/docs/v3/Plugins/SplitText/#onSplit*)
...
-   #### prepareText\*[](https://gsap.com/docs/v3/Plugins/SplitText/#prepareText*)
...
-   #### propIndex\*[](https://gsap.com/docs/v3/Plugins/SplitText/#propIndex*)
...
-   #### reduceWhiteSpace[](https://gsap.com/docs/v3/Plugins/SplitText/#reduceWhiteSpace)
...
-   #### smartWrap\*[](https://gsap.com/docs/v3/Plugins/SplitText/#smartWrap*)
...
-   #### tag[](https://gsap.com/docs/v3/Plugins/SplitText/#tag)
...
-   #### type[](https://gsap.com/docs/v3/Plugins/SplitText/#type)
...
-   #### wordDelimiter[](https://gsap.com/docs/v3/Plugins/SplitText/#wordDelimiter)
...
-   #### wordsClass[](https://gsap.com/docs/v3/Plugins/SplitText/#wordsClass)
...
## Animating[](https://gsap.com/docs/v3/Plugins/SplitText/#animating "Direct link to Animating")
...
### Responsive Line Splitting\*[](https://gsap.com/docs/v3/Plugins/SplitText/#responsive-line-splitting "Direct link to Responsive Line Splitting*")
...
### Masking\*[](https://gsap.com/docs/v3/Plugins/SplitText/#masking "Direct link to Masking*")
...
## Screen Reader Accessibility[](https://gsap.com/docs/v3/Plugins/SplitText/#screen-reader-accessibility "Direct link to Screen Reader Accessibility")
...
### Built-in Aria\*[](https://gsap.com/docs/v3/Plugins/SplitText/#built-in-aria "Direct link to Built-in Aria*")
...
### Alternate Strategy for Maximizing Nested Element Accessibility[](https://gsap.com/docs/v3/Plugins/SplitText/#alternate-strategy-for-maximizing-nested-element-accessibility "Direct link to Alternate Strategy for Maximizing Nested Element Accessibility")
...
## Reverting[](https://gsap.com/docs/v3/Plugins/SplitText/#reverting "Direct link to Reverting")
...
## Tips & Limitations[](https://gsap.com/docs/v3/Plugins/SplitText/#tips--limitations "Direct link to Tips & Limitations")
