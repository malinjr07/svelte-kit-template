...
### Description[](https://gsap.com/docs/v3/Eases/SlowMo/#description "Direct link to Description")
...
### Example code[](https://gsap.com/docs/v3/Eases/SlowMo/#example-code "Direct link to Example code")
