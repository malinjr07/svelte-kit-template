...
### Returns : \[Function | self\][](https://gsap.com/docs/v3/GSAP/Timeline/eventCallback()/#returns--function--self "Direct link to Returns : [Function | self]")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details[](https://gsap.com/docs/v3/GSAP/Timeline/eventCallback()/#details "Direct link to Details")
