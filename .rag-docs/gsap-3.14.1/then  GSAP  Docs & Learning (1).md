...
### Returns : Promise[](https://gsap.com/docs/v3/GSAP/Timeline/then()/#returns--promise "Direct link to Returns : Promise")

Returns a promise so that you can uses promises to track when a tween or timeline is complete.

### Details[](https://gsap.com/docs/v3/GSAP/Timeline/then()/#details "Direct link to Details")
