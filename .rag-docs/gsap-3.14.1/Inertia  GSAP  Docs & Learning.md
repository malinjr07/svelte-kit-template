...
-   #### velocity[](https://gsap.com/docs/v3/Plugins/InertiaPlugin/#velocity)
...
-   #### min[](https://gsap.com/docs/v3/Plugins/InertiaPlugin/#min)
...
-   #### max[](https://gsap.com/docs/v3/Plugins/InertiaPlugin/#max)
...
-   #### end[](https://gsap.com/docs/v3/Plugins/InertiaPlugin/#end)
...
-   #### linkedProps[](https://gsap.com/docs/v3/Plugins/InertiaPlugin/#linkedProps)
...
-   #### resistance[](https://gsap.com/docs/v3/Plugins/InertiaPlugin/#resistance)
...
## **Methods**[](https://gsap.com/docs/v3/Plugins/InertiaPlugin/#methods "Direct link to methods")

|    #### .getVelocity( target:Element | String, property:String ) ;     | Returns the current velocity of the given property and target object (only works if you started tracking the property using the `InertiaPlugin.track()` method). |
|------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| #### .isTracking( target:Element | String, property:String ) : Boolean |                                                                                                                                                                |
|  #### .track( target:Element | String | Array, props:String ) : Array  |                                                                                                                                                                |
|    #### .untrack( target:Element | String | Array, props:String ) ;    |                                                                                                                                                                |
