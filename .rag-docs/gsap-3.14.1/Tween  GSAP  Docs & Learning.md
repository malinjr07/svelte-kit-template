...
-   #### callbackScope[](https://gsap.com/docs/v3/GSAP/Tween/#callbackScope)
...
-   #### ease[](https://gsap.com/docs/v3/GSAP/Tween/#ease)
...
-   #### id[](https://gsap.com/docs/v3/GSAP/Tween/#id)
...
-   #### immediateRender[](https://gsap.com/docs/v3/GSAP/Tween/#immediateRender)
...
-   #### inherit[](https://gsap.com/docs/v3/GSAP/Tween/#inherit)
...
-   #### lazy[](https://gsap.com/docs/v3/GSAP/Tween/#lazy)
...
-   #### onComplete[](https://gsap.com/docs/v3/GSAP/Tween/#onComplete)
    
    A function to call when the animation has completed.
    
-   #### onCompleteParams[](https://gsap.com/docs/v3/GSAP/Tween/#onCompleteParams)
...
-   #### onRepeat[](https://gsap.com/docs/v3/GSAP/Tween/#onRepeat)
...
-   #### onRepeatParams[](https://gsap.com/docs/v3/GSAP/Tween/#onRepeatParams)
    
    An Array of parameters to pass the onRepeat function.
    
-   #### onReverseComplete[](https://gsap.com/docs/v3/GSAP/Tween/#onReverseComplete)
    
    A function to call when the animation has reached its beginning again from the reverse direction (excluding repeats).
    
-   #### onReverseCompleteParams[](https://gsap.com/docs/v3/GSAP/Tween/#onReverseCompleteParams)
    
    An Array of parameters to pass the onReverseComplete function.
    
-   #### onStart[](https://gsap.com/docs/v3/GSAP/Tween/#onStart)
...
-   #### onStartParams[](https://gsap.com/docs/v3/GSAP/Tween/#onStartParams)
    
    An Array of parameters to pass the onStart function.
    
-   #### onUpdate[](https://gsap.com/docs/v3/GSAP/Tween/#onUpdate)
    
    A function to call every time the animation updates (on each "tick" that moves its playhead).
    
-   #### onUpdateParams[](https://gsap.com/docs/v3/GSAP/Tween/#onUpdateParams)
    
    An Array of parameters to pass the onUpdate function.
    
-   #### overwrite[](https://gsap.com/docs/v3/GSAP/Tween/#overwrite)
...
-   #### repeatRefresh[](https://gsap.com/docs/v3/GSAP/Tween/#repeatRefresh)
...
-   #### runBackwards[](https://gsap.com/docs/v3/GSAP/Tween/#runBackwards)
...
-   #### stagger[](https://gsap.com/docs/v3/GSAP/Tween/#stagger)
...
-   #### startAt[](https://gsap.com/docs/v3/GSAP/Tween/#startAt)
...
-   #### yoyoEase[](https://gsap.com/docs/v3/GSAP/Tween/#yoyoEase)
...
| #### eventCallback( type:String, callback:Function, params:Array ) : \[Function | self\] |                                    Gets or sets an event callback like `"onComplete", "onUpdate", "onStart"` or or `"onRepeat"` along with any parameters that should be passed to that callback.                                     |
...
|-----------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                  #### ratio                   | **\[read-only\]** the progress of the Tween (a value between 0 and 1 where 0.5 is in the middle) **after** being run through the `ease`. So this value may exceed the 0-1 range, like in the case of `ease: "back"` or `ease: "elastic"`. It can be useful as a multiplier for your own interpolation, like in an `onUpdate` callback. |
...
|              #### vars : Object               |                                 The configuration object passed into the constructor which contains all the properties/values you want to animate, along with any of the optional **special properties** like like `onComplete`, `onUpdate`, etc., like `gsap.to(".class",{onComplete: func});`                                  |