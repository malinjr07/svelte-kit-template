...
### Returns : self[](https://gsap.com/docs/v3/GSAP/Timeline/resume()/#returns--self "Direct link to Returns : self")

For easier chaining

### Details[](https://gsap.com/docs/v3/GSAP/Timeline/resume()/#details "Direct link to Details")
