...
-   #### autoRemoveChildren[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#autoRemoveChildren)
...
-   #### callbackScope[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#callbackScope)
...
-   #### defaults[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#defaults)
...
-   #### delay[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#delay)
    
    Number Amount of delay in seconds before the animation should begin.
    
-   #### onComplete[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onComplete)
    
    Function A function that should be called when the animation has completed.
    
-   #### onCompleteParams[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onCompleteParams)
...
-   #### onInterrupt[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onInterrupt)
...
-   #### onInterruptParams[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onInterruptParams)
...
-   #### onRepeat[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onRepeat)
    
    Function A function that should be called each time the animation repeats.
    
-   #### onRepeatParams[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onRepeatParams)
...
-   #### onReverseComplete[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onReverseComplete)
...
-   #### onReverseCompleteParams[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onReverseCompleteParams)
...
-   #### onStart[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onStart)
...
-   #### onStartParams[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onStartParams)
...
-   #### onUpdate[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onUpdate)
    
    Function A function that should be called every time the animation updates (on every frame while the animation is active).
    
-   #### onUpdateParams[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#onUpdateParams)
...
-   #### paused[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#paused)
    
    Boolean If `true`, the animation will pause itself immediately upon creation.
    
-   #### repeat[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#repeat)
...
-   #### repeatDelay[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#repeatDelay)
...
-   #### repeatRefresh[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#repeatRefresh)
...
-   #### smoothChildTiming[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#smoothChildTiming)
...
-   #### yoyo[](https://gsap.com/docs/v3/GSAP/Timeline/vars/#yoyo)
