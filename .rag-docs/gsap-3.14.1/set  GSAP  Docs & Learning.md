...
### Returns : self[](https://gsap.com/docs/v3/GSAP/Timeline/set()/#returns--self "Direct link to Returns : self")

self (makes chaining easier)

### Details[](https://gsap.com/docs/v3/GSAP/Timeline/set()/#details "Direct link to Details")
...
## Positioning a set() in a timeline[](https://gsap.com/docs/v3/GSAP/Timeline/set()/#positioning-a-set-in-a-timeline "Direct link to Positioning a set() in a timeline")
...
### Position Parameter Interactive Demo[](https://gsap.com/docs/v3/GSAP/Timeline/set()/#position-parameter-interactive-demo "Direct link to Position Parameter Interactive Demo")
